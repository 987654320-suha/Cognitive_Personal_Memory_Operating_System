...
import { Layers, Mail, Lock, Eye, EyeOff, UserPlus, CheckCircle2 } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-[#0d0d1a] px-4">
      ...
      <div className="absolute w-[400px] h-[400px] bg-purple-600/10 blur-[100px] rounded-full pointer-events-none -bottom-20 -right-20" />
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-xs text-gray-400 mt-1">Start your personal AI cognitive memory space</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-300 uppercase tracking-wider mb-1.5">
              Password <span className="text-[10px] text-gray-500 font-normal lowercase">(min 8 chars)</span>
            </label>
            <div className="relative">
          ...
          <div>
            ...
            <div className="relative">
              <CheckCircle2 size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400" />
              <input
                type={showPass ? "text" : "password"}
                required
                value={confirmPass}
